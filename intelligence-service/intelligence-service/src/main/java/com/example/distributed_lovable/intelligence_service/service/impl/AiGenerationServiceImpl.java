...
import com.example.distributed_lovable.intelligence_service.llm.LlmResponseParser;
import com.example.distributed_lovable.intelligence_service.llm.PromptUtils;
import com.example.distributed_lovable.intelligence_service.llm.advisor.FileTreeContextAdvisor;
import com.example.distributed_lovable.intelligence_service.llm.tools.CodeGenerationTools;
import com.example.distributed_lovable.intelligence_service.repository.ChatEventRepository;
...
//                        projectFileService.saveFile(projectId, e.getFilePath(), e.getContent()
                    FileStoreRequestEvent fileStoreRequestEvent = new
