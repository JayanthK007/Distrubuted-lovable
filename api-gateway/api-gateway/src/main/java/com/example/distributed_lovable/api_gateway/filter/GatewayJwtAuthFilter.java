package com.example.distributed_lovable.api_gateway.filter;

import com.example.distributed_lovable.api_gateway.config.SecurityConfig;
import com.example.distributed_lovable.api_gateway.error.ApiError;
import com.example.distributed_lovable.api_gateway.service.JwtGatewayService;
...
public class GatewayJwtAuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        boolean isPublic = securityConfig.getPublicRoutes().stream()
        ...
        String authHeader = serverHttpRequest.getHeaders().getFirst("Authorization");
